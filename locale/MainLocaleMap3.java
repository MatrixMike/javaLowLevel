...
//#3         System.out.printf(" %s %s %n", navMap1, navMap2);  // sorted alphabetically
//         System.out.printf("%n%s %n", navMap2);  // sorted alphabetically
  //  System.out.printf("%n%s %n", navMap);  // sorted alphabetically
  
  // Sentence construction : the land is between the () but not yet understood how to extract this...
		System.out.println("In "+localesN[i].getDisplayName() +" they speak " +   localesN[i].getDisplayLanguage()  +"."          );
		System.out.println();
    /* Whole list:
