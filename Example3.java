...
public class Example3 {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> numbers = Arrays.asList(1, 2, 3, 4, 5, 6, -3, -6, 7, 8, 9, 10);
        ...
        System.out.println("Count of all numbers : " + stats.getCount());  // mike
        System.out.println("String representation: " + stats.toString());  // mike
    }
